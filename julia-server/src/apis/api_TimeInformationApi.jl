...
function registerTimeInformationApi(router::HTTP.Router, impl; path_prefix::String="", optional_middlewares...)
    HTTP.register!(router, "GET", path_prefix * "/get_current_time", OpenAPI.Servers.middleware(impl, get_current_time_read, get_current_time_validate, get_current_time_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_end_time", OpenAPI.Servers.middleware(impl, get_end_time_read, get_end_time_validate, get_end_time_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_start_time", OpenAPI.Servers.middleware(impl, get_start_time_read, get_start_time_validate, get_start_time_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_time_step", OpenAPI.Servers.middleware(impl, get_time_step_read, get_time_step_validate, get_time_step_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_time_units", OpenAPI.Servers.middleware(impl, get_time_units_read, get_time_units_validate, get_time_units_invoke; optional_middlewares...))
    return router
end
