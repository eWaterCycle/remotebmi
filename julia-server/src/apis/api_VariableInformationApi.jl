...
function registerVariableInformationApi(router::HTTP.Router, impl; path_prefix::String="", optional_middlewares...)
    HTTP.register!(router, "GET", path_prefix * "/get_var_grid/{name}", OpenAPI.Servers.middleware(impl, get_var_grid_read, get_var_grid_validate, get_var_grid_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_var_itemsize/{name}", OpenAPI.Servers.middleware(impl, get_var_itemsize_read, get_var_itemsize_validate, get_var_itemsize_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_var_location/{name}", OpenAPI.Servers.middleware(impl, get_var_location_read, get_var_location_validate, get_var_location_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_var_nbytes/{name}", OpenAPI.Servers.middleware(impl, get_var_nbytes_read, get_var_nbytes_validate, get_var_nbytes_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_var_type/{name}", OpenAPI.Servers.middleware(impl, get_var_type_read, get_var_type_validate, get_var_type_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_var_units/{name}", OpenAPI.Servers.middleware(impl, get_var_units_read, get_var_units_validate, get_var_units_invoke; optional_middlewares...))
    return router
end
