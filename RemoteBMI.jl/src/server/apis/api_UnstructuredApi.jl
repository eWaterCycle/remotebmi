...
function registerUnstructuredApi(
  router::HTTP.Router,
  impl;
  path_prefix::String = "",
  ...
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_edge_count/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_edge_count_read,
      get_grid_edge_count_validate,
      get_grid_edge_count_invoke;
      optional_middlewares...,
    ),
  )
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_edge_nodes/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_edge_nodes_read,
      get_grid_edge_nodes_validate,
      get_grid_edge_nodes_invoke;
      optional_middlewares...,
    ),
  )
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_face_count/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_face_count_read,
      get_grid_face_count_validate,
      get_grid_face_count_invoke;
      optional_middlewares...,
    ),
  )
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_face_edges/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_face_edges_read,
      get_grid_face_edges_validate,
      get_grid_face_edges_invoke;
      optional_middlewares...,
    ),
  )
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_face_nodes/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_face_nodes_read,
      get_grid_face_nodes_validate,
      get_grid_face_nodes_invoke;
      optional_middlewares...,
    ),
  )
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_node_count/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_node_count_read,
      get_grid_node_count_validate,
      get_grid_node_count_invoke;
      optional_middlewares...,
    ),
  )
  HTTP.register!(
    router,
    "GET",
    path_prefix * "/get_grid_nodes_per_face/{grid}",
    OpenAPI.Servers.middleware(
      impl,
      get_grid_nodes_per_face_read,
      get_grid_nodes_per_face_validate,
      get_grid_nodes_per_face_invoke;
      optional_middlewares...,
    ),
  )
  return router
