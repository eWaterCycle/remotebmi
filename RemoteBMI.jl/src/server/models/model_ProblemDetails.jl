...
const _property_types_ProblemDetails = Dict{Symbol, String}(
  Symbol("type") => "String",
  Symbol("title") => "String",
  Symbol("status") => "Int64",
...
OpenAPI.property_type(::Type{ProblemDetails}, name::Symbol) =
  Union{Nothing, eval(Base.Meta.parse(_property_types_ProblemDetails[name]))}
