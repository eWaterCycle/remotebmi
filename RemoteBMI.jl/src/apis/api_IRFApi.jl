...
function registerIRFApi(router::HTTP.Router, impl; path_prefix::String="", optional_middlewares...)
    HTTP.register!(router, "DELETE", path_prefix * "/finalize", OpenAPI.Servers.middleware(impl, finalize_read, finalize_validate, finalize_invoke; optional_middlewares...))
    HTTP.register!(router, "POST", path_prefix * "/initialize", OpenAPI.Servers.middleware(impl, initialize_read, initialize_validate, initialize_invoke; optional_middlewares...))
    HTTP.register!(router, "POST", path_prefix * "/update", OpenAPI.Servers.middleware(impl, update_read, update_validate, update_invoke; optional_middlewares...))
    HTTP.register!(router, "POST", path_prefix * "/update_until", OpenAPI.Servers.middleware(impl, update_until_read, update_until_validate, update_until_invoke; optional_middlewares...))
    return router
end
