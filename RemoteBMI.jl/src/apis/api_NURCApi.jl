...
function registerNURCApi(router::HTTP.Router, impl; path_prefix::String="", optional_middlewares...)
    HTTP.register!(router, "GET", path_prefix * "/get_grid_x/{grid}", OpenAPI.Servers.middleware(impl, get_grid_x_read, get_grid_x_validate, get_grid_x_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_grid_y/{grid}", OpenAPI.Servers.middleware(impl, get_grid_y_read, get_grid_y_validate, get_grid_y_invoke; optional_middlewares...))
    HTTP.register!(router, "GET", path_prefix * "/get_grid_z/{grid}", OpenAPI.Servers.middleware(impl, get_grid_z_read, get_grid_z_validate, get_grid_z_invoke; optional_middlewares...))
    return router
end
