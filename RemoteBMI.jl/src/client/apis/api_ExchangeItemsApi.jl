...
function _oacinternal_get_component_name(_api::ExchangeItemsApi; _mediaType = nothing)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_component_name_ExchangeItemsApi,
    "/get_component_name",
    [],
  )
...
function _oacinternal_get_input_item_count(_api::ExchangeItemsApi; _mediaType = nothing)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_input_item_count_ExchangeItemsApi,
...
function _oacinternal_get_input_var_names(_api::ExchangeItemsApi; _mediaType = nothing)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_input_var_names_ExchangeItemsApi,
    "/get_input_var_names",
    [],
  )
  OpenAPI.Clients.set_header_accept(_ctx, ["application/json"])
...
function _oacinternal_get_output_item_count(_api::ExchangeItemsApi; _mediaType = nothing)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_output_item_count_ExchangeItemsApi,
...
function get_output_item_count(
  _api::ExchangeItemsApi,
  response_stream::Channel;
  _mediaType = nothing,
)
...
function _oacinternal_get_output_var_names(_api::ExchangeItemsApi; _mediaType = nothing)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_output_var_names_ExchangeItemsApi,
