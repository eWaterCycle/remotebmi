...
function _oacinternal_get_grid_origin(
  _api::UniformRectilinearApi,
  grid::Int64;
  _mediaType = nothing,
)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_grid_origin_UniformRectilinearApi,
...
function _oacinternal_get_grid_shape(_api::UniformRectilinearApi, grid::Int64; _mediaType = nothing)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_grid_shape_UniformRectilinearApi,
    "/get_grid_shape/{grid}",
    [],
  )
  OpenAPI.Clients.set_param(_ctx.path, "grid", grid)  # type Int64
...
function _oacinternal_get_grid_spacing(
  _api::UniformRectilinearApi,
  grid::Int64;
  _mediaType = nothing,
)
  _ctx = OpenAPI.Clients.Ctx(
    _api.client,
    "GET",
    _returntypes_get_grid_spacing_UniformRectilinearApi,
