...
function _oacinternal_get_grid_rank(_api::GridInformationApi, grid::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_grid_rank_GridInformationApi, "/get_grid_rank/{grid}", [])
...
function get_grid_rank(_api::GridInformationApi, response_stream::Channel, grid::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_grid_rank(_api, grid; _mediaType=_mediaType)
...
function _oacinternal_get_grid_size(_api::GridInformationApi, grid::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_grid_size_GridInformationApi, "/get_grid_size/{grid}", [])
    OpenAPI.Clients.set_param(_ctx.path, "grid", grid)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
function get_grid_size(_api::GridInformationApi, response_stream::Channel, grid::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_grid_size(_api, grid; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
function _oacinternal_get_grid_type(_api::GridInformationApi, grid::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_grid_type_GridInformationApi, "/get_grid_type/{grid}", [])
    OpenAPI.Clients.set_param(_ctx.path, "grid", grid)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
function get_grid_type(_api::GridInformationApi, response_stream::Channel, grid::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_grid_type(_api, grid; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
