...
- Go back to main screen and click on the latest commit (link: <https://github.com/eWaterCycle/RemoteBMI.jl/commit/main>)
...
- After the merge happens, TagBot will trigger and create a new GitHub tag. Check on <https://github.com/eWaterCycle/RemoteBMI.jl/releases>
- After the release is create, a "docs" GitHub action will start for the tag.
- After it passes, a deploy action will run.
- After that runs, the [stable docs](https://eWaterCycle.github.io/RemoteBMI.jl/stable) should be updated. Check them and look for the version number.
